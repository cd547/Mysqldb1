...
--
-- Host: 127.0.0.1
-- Generation Time: 2019-04-10 08:06:47
-- 服务器版本： 5.7.14
-- PHP Version: 5.6.25
...
CREATE TABLE `项目` (
  ...
  `备注` varchar(128) COLLATE utf8_bin NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `项目` (`Id`, `项目名称`, `工令`, `合同号`, `买方名称`, `金额`, `签订日期`, `交货日期`, `创建日期`, `修改日期`, `备注`) VALUES
(1, '逆变一体机', '319002', 'N19-SA02-PV008.002', '东芝三菱电机工业系统（中国）有限公司', '5914400.00', '2019-03-27', '2019-03-27', NULL, NULL, '');
